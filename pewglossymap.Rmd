...
```{r}
  r1 <- raster(here("inst/app/www/scenarios/s04a.biofish.alltime.mol50km_sol.tif"))
  r2 <- raster(here("inst/app/www/scenarios/s01a.bio.now.mol50km_sol.tif"))
  ...
  writeRaster(r_dsm, "inst/scripts/pewglossymap/s04-s01.tif")
...
# Create shapefile
  ...
  write_sf(p_dsm, "inst/scripts/pewglossymap/s04-s01.shp")
  
  
# Create png
  
png<- ("inst/scripts/pewglossymap/s04-s01.png")
  # overlays

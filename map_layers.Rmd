...
pal  <- colorRampPalette(brewer.pal(11, "YlOrRd"))
...
s04_r <- raster(here("../bbnj/inst/app/www/scenarios/s04a.biofish.alltime.mol50km_sol.tif"))
s04_r <- mask(s04_r, s04_r, maskvalue=0)
P
...
=======
>>>>>>> 437587b2ae4e44535f13019b6bad85fa1e435245
    map25_png %>%

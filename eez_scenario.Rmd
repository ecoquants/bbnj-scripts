...
summarise(x, length_km = sum(length_km))

datatable(st_drop_geometry(x), caption = "Intersection of Scenario 4a with individual EEZs.")

datatable(st_drop_geometry(x_sov), caption = "Intersection of Scenario 4a with EEZs grouped by Sovereign1.")
```

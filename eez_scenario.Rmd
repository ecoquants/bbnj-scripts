...
x_ldc_csv <- glue("{dir_out}/s04a_eez_ldc.csv")
x_ldc_shp <- glue("{dir_out}/s04a_eez_ldc.shp")
...
eezldc_shp <- glue("{dir_out}/eezldc.shp")
...
if (!file.exists(x_csv)){
  ...
  write_csv(st_drop_geometry(x_ldc), x_ldc_csv)
  
  write_sf(x, x_shp)
  write_sf(x_sov, x_sov_shp)
  write_sf(x_ldc, x_ldc_shp)

...
```
Total number of EEZs globally (excluding disputed areas and joint claims): `r nrow(p_eez_s05_mol)`
...
x_sov %>% 
  ...
  formatRound(columns=c("length_km"), digits=1)
```
Total number of sovereign EEZs globally (excluding disputed areas and joint claims): `r nrow(eez_sov)`

...
#MV Note 11/6/19: Attempted to add st_collection_extract("MULTIPOLYGON") and st_cast("MULTIPOLYGON") at line 165 to convert p_s_l[4,] (North Pacific) from GEOMETRYCOLLECTION to MULTIPOLYGON. Right now the filtering on line 166 removes North Pacific entirely.
